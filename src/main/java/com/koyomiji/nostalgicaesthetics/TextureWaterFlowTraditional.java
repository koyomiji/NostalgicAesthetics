 ...
 */
public class TextureWaterFlowTraditional extends TextureAtlasSprite {
  ...
  public TextureWaterFlowTraditional(String p_i1282_1_) {
    super(p_i1282_1_);
  }
  ...
  public void updateAnimation() {
    ...
    for (int $1 = 0; $1 < 16; $1++) {
      for (int $2 = 0; $2 < 16; $2++) {
        ...
        this.green[$1 + $2 * 16] = $3 / 3.2F + this.blue[$1 + $2 * 16] * 0.8F;
      }
    }
    ...
    for (int $12 = 0; $12 < 16; $12++) {
      for (int $14 = 0; $14 < 16; $14++) {
        ...
        this.alpha[$12 + $14 * 16] = this.alpha[$12 + $14 * 16] - 0.3F;
        if (Math.random() < 0.2) {
    ...
    for (int $15 = 0; $15 < 256; $15++) {
      float $16 = this.red[$15 - this.tickCounter * 16 & 0xFF];
      if ($16 > 1.0F) {
        $16 = 1.0F;
      }
